...
int Bab_LBUpd(const double new_lb, const BabSolution *bs);       // checks and updates lower bound if better found, returns 1 if success
...
void Bab_LBInit(const double lowerBound, const BabSolution *bs); // initialize global lower bound and solution vector
